...
export default function Footer() {
  ...
  // <div className="relative z-10">
      <div className="h-screen bg-navy flex items-center justify-center flex-col">
        <div className="flex items-center w-4/5 gap-40">
          <div>
            <h1 className="text-white text-2xl mb-5">CONTACT ME</h1>
            <h2 className="text-blue text-2xl">email@email.com</h2>
          </div>
          <div>
            <h1 className="text-2xl text-purple cursor-pointer mb-5 mt-20">
              <a href={"/"}>Home</a>
            </h1>
